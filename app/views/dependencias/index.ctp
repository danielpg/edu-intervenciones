<div class="dependencias index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $dependencia['Dependencia']['fecha_creacion']; ?>&nbsp;</td>
		<td><?php echo $dependencia['Dependencia']['fecha_modificacion']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $a = null;#a = null;#a = null;#a = null;#this->Html->link(__('View', true), array('action' => 'view', $dependencia['Dependencia']['id'])); ?>
			<?php echo $this->Html->link(__('Editarar', true), array('action' => 'edit', $dependencia['Dependencia']['id'])); ?>
			<?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $dependencia['Dependencia']['id']), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $dependencia['Dependencia']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
