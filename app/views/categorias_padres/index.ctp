<div class="categorias index">
	<h2><?php __('Categorías de Temáticas');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $categoria['CategoriasPadre']['id']; ?>&nbsp;</td>
		<td><?php echo $categoria['CategoriasPadre']['nombre']; ?>&nbsp;</td>

		<td class="actions">
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $categoria['CategoriasPadre']['id'])); ?>
			<?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $categoria['CategoriasPadre']['id']), null, sprintf(__('¿Usted quiere eliminar la Categoría # %s?', true), $categoria['CategoriasPadre']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
