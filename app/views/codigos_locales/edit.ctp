...
<?php echo $this->Form->create('CodigosLocal');?>
	<fieldset>
		<legend><?php __('Editarar Codigos Local'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('CodigosLocal.id')), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $this->Form->value('CodigosLocal.id'))); ?></li>
