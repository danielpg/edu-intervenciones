<div class="modalidades index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $modalidad['Modalidad']['fecha_creacion']; ?>&nbsp;</td>
		<td><?php echo $modalidad['Modalidad']['fecha_modificacion']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $a = null;#a = null;#a = null;#a = null;#this->Html->link(__('View', true), array('action' => 'view', $modalidad['Modalidad']['id'])); ?>
			<?php echo $this->Html->link(__('Editarar', true), array('action' => 'edit', $modalidad['Modalidad']['id'])); ?>
			<?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $modalidad['Modalidad']['id']), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $modalidad['Modalidad']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
