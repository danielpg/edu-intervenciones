...
<?php echo $this->Form->create('Modalidad');?>
	<fieldset>
		<legend><?php __('Editarar Modalidad'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Modalidad.id')), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $this->Form->value('Modalidad.id'))); ?></li>
