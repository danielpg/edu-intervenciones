...
<script type="text/javascript">
 ...
 <script>
  $(function() {
    ...
    $( "#FormAutoNucleo" ).autocomplete({
      minLength: 0,
      source: "<?php echo Router::url('/estudiantes/nucleo_autocomplete') ?>",
      focus: function( event, ui ) {
        $( "#FormAutoNucleo" ).val( ui.item.nombre );
        return false;
      },
      select: function( event, ui ) {
        $( "#FormAutoNucleo" ).val( ui.item.nombre );
        $( "#FormAutoNucleoId" ).val( ui.item.id );
		...
		<div align="center"><table width="1019px"><tr><td><div id="content">
				...
				<tr class="top_table_top">
					<td style="text-align:left">
						<span style="color:darkblue;font-size:20px;font-family:Arial black;position:relative;top:6px">MINEDU</span>
					...
					<td >
						<div class="divlogout" style="text-align:right;">
								...
								<?php echo Credentials::get('__credentials.Login.nombres') ?> | <a style="color:#DBA80E;" href="<?php echo $html->url(array('controller'=>'authentication','action'=>'logout')) ?>"><?php __("Cerrar Sesi&oacute;n") ?></a>
								</div>
				...
				<tr class="top_table_middle">
					<td colspan="2">
						...
						<td width="100%">
								...
								<ul class="sf-menu">
								<?php if(Credentials::get("__credentials.Login.role_id")==1): ?>
								<li><a href="#">Definiciones&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
									<ul>
										<li><?php echo $this->Html->link(__('Departamentos', true), array('controller' => 'departamentos', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Provincias', true), array('controller' => 'provincias', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Distritos', true), array('controller' => 'distritos', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Centros Poblados', true), array('controller' => 'centros_poblados', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Formatos', true), array('controller' => 'formatos', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Materiales', true), array('controller' => 'materiales', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Validaciones', true), array('controller' => 'validaciones', 'action' => 'index')); ?> </li>

										<li><?php echo $this->Html->link(__('Caracteristicas Participantes', true), array('controller' => 'caracteristicas_participantes', 'action' => 'index')); ?> </li>									
										<li><?php echo $this->Html->link(__('Caracteristicas Estudiantes', true), array('controller' => 'caracteristicas_estudiantes', 'action' => 'index')); ?> </li>								
										<li><?php echo $this->Html->link(__('Caracteristicas Nucleos', true), array('controller' => 'caracteristicas_nucleos', 'action' => 'index')); ?> </li>	
										<li><?php echo $this->Html->link(__('Nucleos Roles', true), array('controller' => 'nucleos_roles', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Historial Formatos', true), array('controller' => 'historial_formatos', 'action' => 'index')); ?></li>
									</ul>
								</li>
								<?php endif; ?>
								<li><a href="#">Nucleos</a>
									<ul>
										<?php if(Credentials::get("__credentials.Login.role_id")==1): ?>
										<li><?php echo $this->Html->link(__('Nucleos', true), array('controller' => 'nucleos', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Detalle Nucleos', true), array('controller' => 'detalle_nucleos', 'action' => 'index')); ?> </li>						
										<?php endif; ?>

										<?php if(Credentials::can("historial_nucleos_view")): ?>
										<li><?php echo $this->Html->link(__('Historial Nucleos', true), array('controller' => 'historial_nucleos', 'action' => 'index')); ?></li>
										<?php endif; ?>

										<?php if(Credentials::can("materiales_view")): ?>
										<li><?php echo $this->Html->link(__('Inventario', true), array('controller' => 'materiales_nucleos', 'action' => 'index')); ?> </li>
										<?php endif; ?>

										<?php if(Credentials::can("participantes_view")): ?>
										<li><?php echo $this->Html->link(__('Participantes', true), array('controller' => 'participantes', 'action' => 'index')); ?> </li>
										<li><?php echo $this->Html->link(__('Historial Participantes', true), array('controller' => 'historial_participantes', 'action' => 'index')); ?></li>
										<?php endif; ?>
									</ul>	
								</li>
								<?php if(Credentials::get("__credentials.Login.role_id")==1): ?>
								<li><a href="#">II. EE.</a>
									<ul>
										<li><?php echo $this->Html->link(__('Listado', true), array('controller' => 'centros_educativos', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link(__('Nuevo', true), array('controller' => 'centros_educativos', 'action' => 'add')); ?></li>
										<li><?php echo $this->Html->link(__('Detalles', true), array('controller' => 'detalle_centros_educativos', 'action' => 'index')); ?></li>

									</ul>	
								</li>
								<li><a href="#">Organización</a>
									<ul>
										<li><?php echo $this->Html->link(__('DREs', true), array('controller' => 'dres', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link(__('UGELs', true), array('controller' => 'unidades', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link(__('Cargos', true), array('controller' => 'cargos', 'action' => 'index')); ?></li>
									</ul>	
								</li>
								<?php endif; ?>
								<?php if(Credentials::get("__credentials.Login.role_id")!=3): ?>
								<li><a href="#">Formatos</a>
									<ul>
										<li><?php echo $this->Html->link("Formato 01", array('controller' => 'estudiantes', 'action' => 'addformato')); ?></li>
										<li><?php echo $this->Html->link("Formato 03", array('controller' => 'historial_nucleos', 'action' => 'addformat')); ?></li>
										<li><?php echo $this->Html->link("Formato 04", array('controller' => 'historial_participantes', 'action' => 'addformat')); ?></li>
										<li><?php echo $this->Html->link("Formato 05", array('controller' => 'materiales_nucleos', 'action' => 'add_periodo')); ?></li>
										<li><?php echo $this->Html->link("Formato 06", array('controller' => 'talentos', 'action' => 'addformato')); ?></li>
									</ul>	
								</li>
								<?php endif; ?>
								<?php if(Credentials::can("estudiantes_view")): ?>
								<li><a href="#">Estudiantes</a>
									<ul>
										<li><?php echo $this->Html->link(__('Estudiantes', true), array('controller' => 'estudiantes', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link(__('Historial Estudiantes', true), array('controller' => 'historial_estudiantes', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link(__('Talentos', true), array('controller' => 'talentos', 'action' => 'index')); ?> </li>
