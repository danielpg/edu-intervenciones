...
.table_fields td {padding:4px;width:180px}
	...
	<div id="container">
		...
		<div><table width="1019px"><tr><td><div id="content">
		
				<table id="top_table" width="1018px" cellpadding="0" cellspacing="0">
				<tr class="top_table_top">
					<td style="text-align:left">
						<?php echo $html->image("logo_med.png") ?>
						<span style="color: #5c5c61;    font-size: 28px;    font-family: Arial black;    position: relative;    top: -12px;    padding-left: 11px;">INTERVENCIONES</span>
					...
					<td >
						<div class="divlogout" style="text-align:right;">
								...
								<?php echo Credentials::get('__credentials.Login.nombre') ?> | <a style="color:#DBA80E;" href="<?php echo $html->url(array('controller'=>'authentication','action'=>'logout')) ?>"><?php __("Cerrar Sesi&oacute;n") ?></a>
								</div>
				...
				<tr class="top_table_middle">
					<td colspan="2">
						...
						<td width="100%">
							<ul class="sf-menu">
								<?php if(true): ?>
								<li><a href="#"><i class='fa fa-newspaper-o'></i> Temáticas</a>
									<ul>
										<li><?php echo $this->Html->link("Categorías de Temáticas", array('controller' => 'categorias_padres', 'action' => 'index')); ?></li>
										<li><?php echo $this->Html->link("Temáticas", array('controller' => 'categorias', 'action' => 'index')); ?></li>
									</ul>	
								</li>


								<li> <?php echo $this->Html->link("<i class='fa fa-bank'></i> Fuentes de Financiamiento", array('controller' => 'organos', 'action' => 'index'),array('escape' => false)); ?></li>

								<li><?php echo $this->Html->link("<i class='fa fa-map-marker'></i> Intervenciones", array('controller' => 'intervenciones', 'action' => 'index'),array('escape' => false)); ?></li>
		
								<li><?php echo $this->Html->link("<i class='fa fa-building-o'></i> Código Modular", array('controller' => 'valores', 'action' => 'index'),array('escape' => false)); ?></li>


								<?php endif; ?>
								<?php if(Credentials::get("__credentials.Login.role_id")==1): ?>
								<li><a href="#"><i class='fa fa-cogs'></i> Sistema</a>
									<ul>
