...
.table_fields td {padding:4px;width:180px}
	...
	<div id="container">
		...
		<div align="center"><span class="lbutton"><?php echo $this->Html->link('Agregar Nuevo',array('action'=>'add')); ?></span><table width="1019px"><tr><td><div id="content">
		
				<span class="lbutton"><?php echo $this->Html->link('Agregar Nuevo',array('action'=>'add')); ?></span><table id="top_table" width="1018px" cellpadding="0" cellspacing="0">
				...
				<tr class="top_table_middle">
					<td colspan="2">
						<span class="lbutton"><?php echo $this->Html->link('Agregar Nuevo',array('action'=>'add')); ?></span><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
						<td width="100%">
								...
								<li><?php echo $a = null;#a = null;#a = null;#a = null;#this->Html->link(__('Vacantes', true), array('controller' => 'registros', 'action' => 'vacantes')); ?>
								</li>
								<?php if(false &&Credentials::get("__credentials.Login.role_id")==1): ?>
								<li><a href="#">Sistema</a>
									<ul>
				...
				<span class="lbutton"><?php echo $this->Html->link('Agregar Nuevo',array('action'=>'add')); ?></span><table id="middle_table" width="1018px" cellpadding="0" cellspacing="0">
				<tr>
						<!-- LEFT SIDE -->
