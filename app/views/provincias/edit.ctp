...
<?php echo $this->Form->create('Provincia');?>
	<fieldset>
		<legend><?php __('Editar Provincia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Provincia.id')), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $this->Form->value('Provincia.id'))); ?></li>
