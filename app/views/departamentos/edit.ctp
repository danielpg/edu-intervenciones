...
<?php echo $this->Form->create('Departamento');?>
	<fieldset>
		<legend><?php __('Editar Departamento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Departamento.id')), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $this->Form->value('Departamento.id'))); ?></li>
