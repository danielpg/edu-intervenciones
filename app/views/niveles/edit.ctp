...
<?php echo $this->Form->create('Nivel');?>
	<fieldset>
		<legend><?php __('Editarar Nivel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Nivel.id')), null, sprintf(__('Esta seguro de querer eliminar # %s?', true), $this->Form->value('Nivel.id'))); ?></li>
