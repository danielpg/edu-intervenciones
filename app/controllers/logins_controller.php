...
*/
	...
	function edit($id = null) {
		...
		if (empty($this->data)) {
			...
			if(!empty($this->data["Login"]["nucleo_id"])){
				$check = $this->Login->Nucleo->find('first',array("conditions"=>array("Nucleo.id"=>$this->data["Login"]["nucleo_id"] ) ) );
				$this->data["Login"]["nucleo"] = $check["Nucleo"]["nombre"];
			}
		}
